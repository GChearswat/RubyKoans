...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Inject takes in an initial variable parameter, and then loops through the array with the block provided
  end
  ...
  #   # code to read 'file'
  #
  # Answer: When opening the file, the file "opened" is limited to in that block. 
  # In the second example, the file that was opened is available to other functions
  #
